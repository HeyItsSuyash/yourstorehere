  ...
  const reviews = [
    {
      ...
      comment:
        'Your Store Here has made grocery shopping so easy and convenient. The quality of fresh veggies and Amul milk is top-notch, and delivery is super fast!',
      rating: 5,
    ...
    <section className="my-10 bg-white rounded-xl border border-slate-200/80 p-6 sm:p-8">
      <div className="text-center max-w-xl mx-auto mb-8">
        ...
        <p className="text-xs sm:text-sm text-slate-500 font-medium mt-1">
          See why your neighbors trust Your Store Here for their daily kitchen & home supplies
        </p>
      </div>
