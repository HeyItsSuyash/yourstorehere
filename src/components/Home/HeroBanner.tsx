...
export const HeroBanner: React.FC = () => {
  return (
    <div className="my-4">
      {/* Main Hero Card */}
      <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-orange-50 via-amber-50 to-orange-50 border border-orange-200/70 p-6 sm:p-10 lg:p-12 shadow-xs">
        {/* Subtle background circles */}
        <div className="absolute top-0 right-0 -mt-16 -mr-16 w-80 h-80 rounded-xl bg-orange-200/30 blur-3xl pointer-events-none" />
        <div className="absolute bottom-0 left-1/3 -mb-16 w-60 h-60 rounded-xl bg-orange-200/30 blur-2xl pointer-events-none" />
          ...
          <div className="lg:col-span-7 space-y-5 text-left">
            ...
            <div className="flex flex-wrap items-center gap-3.5 pt-2">
              ...
              <Link
                ...
                className="inline-flex items-center gap-2 bg-white hover:bg-slate-50 text-slate-800 font-bold text-sm sm:text-base px-6 py-3.5 rounded-xl border border-slate-300 transition-all hover:border-orange-300"
              >
          ...
          <div className="lg:col-span-5 relative flex justify-center items-center">
            ...
            <div className="relative w-full max-w-md aspect-4/3 rounded-xl overflow-hidden shadow-2xl border-4 border-white">
              <img
                ...
                alt="Fresh Groceries in Basket - Your Store Here"
