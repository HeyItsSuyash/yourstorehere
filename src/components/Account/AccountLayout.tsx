  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <aside className="lg:col-span-4 bg-white rounded-xl p-6 border border-slate-200/80 shadow-xs space-y-6">
          {/* User Mini Profile Header */}
          <div className="flex items-center gap-3.5 pb-6 border-b border-slate-100">
            <div className="w-14 h-14 rounded-xl bg-[#ea580c] text-white font-black text-xl flex items-center justify-center shadow-md">
          ...
          <nav className="space-y-1">
            ...
            <button
              ...
              className="w-full flex items-center justify-between px-3.5 py-2.5 rounded-xl text-xs font-bold text-rose-600 hover:bg-rose-50 transition-colors mt-4 pt-4 border-t border-slate-100"
            >
              <div className="flex items-center gap-3">
        ...
        <main className="lg:col-span-8 bg-white rounded-xl p-6 sm:p-8 border border-slate-200/80 shadow-xs">
          {children}
        </main>
      </div>
    </div>
