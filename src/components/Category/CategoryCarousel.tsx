      ...
      >
        {categories.map((cat) => (
          <Link
            ...
            className="shrink-0 w-28 sm:w-36 md:w-40 group flex flex-col items-center bg-white rounded-2xl p-3 border border-slate-200/70 hover:border-emerald-500/50 hover:shadow-md transition-all duration-200 hover:-translate-y-1"
          >
            <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden bg-emerald-50/60 p-1 flex items-center justify-center group-hover:scale-105 transition-transform duration-200 border border-emerald-100">
              <img
                src={cat.image}
                alt={cat.name}
                loading="lazy"
