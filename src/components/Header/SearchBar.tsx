        ...
        {!isMobile && (
          <div className="flex items-center pr-3 border-r border-slate-200 mr-3">
            <select
              ...
              className="text-xs font-semibold text-slate-700 bg-transparent outline-none cursor-pointer hover:text-emerald-800"
            >
                ...
                <div>
                  ...
                  {filteredSuggestions.map((prod) => (
                    <div
                      ...
                      className="flex items-center justify-between px-4 py-2.5 hover:bg-emerald-50/60 cursor-pointer transition-colors border-b border-slate-50 last:border-0"
                    >
                  ...
                  <div
                    onClick={() => handleSearch(query)}
                    className="p-3 bg-emerald-50 text-emerald-800 text-xs font-bold text-center cursor-pointer hover:bg-emerald-100 flex items-center justify-center gap-1.5"
                  >
