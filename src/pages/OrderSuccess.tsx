  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-12">
      <div className="bg-white rounded-xl-none p-6 sm:p-10 border border-slate-200/80 shadow-md text-center space-y-6">
        {/* Animated Check */}
        <div className="w-20 h-20 bg-orange-100 text-[#ea580c] rounded-xl-none mx-auto flex items-center justify-center shadow-inner">
          <CheckCircle2 className="w-12 h-12" />
        </div>

        <div className="space-y-1">
          <span className="text-xs font-bold text-[#c2410c] uppercase tracking-widest bg-orange-50 px-3 py-1 rounded-xl-none border border-orange-200">
            Order Confirmed
          </span>
        ...
        <div className="flex flex-col sm:flex-row gap-3 pt-2">
          ...
          <Link
            to="/shop"
            className="flex-1 flex items-center justify-center gap-2 bg-white hover:bg-slate-50 text-slate-800 font-bold text-sm py-3.5 px-6 rounded-xl-none border border-slate-300 transition-all hover:border-orange-300"
          >
