      ...
      <div className="bg-white rounded-xl p-6 sm:p-8 border border-slate-200/80 shadow-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="flex items-center bg-slate-50 border border-slate-300 rounded-xl px-3.5 py-3 focus-within:border-orange-300 focus-within:ring-2 focus-within:ring-green-100 transition-all">
