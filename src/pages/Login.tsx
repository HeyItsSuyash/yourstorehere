    ...
    <div className="max-w-md mx-auto px-4 py-16">
      <div className="bg-white rounded-xl p-6 sm:p-8 border border-slate-200/80 shadow-md">
        ...
        <div className="text-center space-y-2 mb-6">
          <div className="w-12 h-12 rounded-xl bg-[#16a34a] text-white flex items-center justify-center mx-auto shadow-md">
            <ShoppingBag className="w-6 h-6" />
          </div>
          <h1 className="text-2xl font-black text-slate-900">
            Welcome to Express daily Mart
          </h1>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="flex items-center bg-slate-50 border border-slate-300 rounded-xl px-3.5 py-3 focus-within:border-green-300 focus-within:ring-2 focus-within:ring-green-100 transition-all">
          ...
          <button
            type="submit"
            className="w-full flex items-center justify-center gap-2 bg-[#16a34a] hover:bg-[#15803d] text-white font-black text-sm py-3.5 rounded-xl shadow-md transition-all "
          >
            <span>CONTINUE</span>
