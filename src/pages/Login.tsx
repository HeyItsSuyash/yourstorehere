    ...
    <div className="max-w-md mx-auto px-4 py-16">
      <div className="bg-white rounded-xl-none p-6 sm:p-8 border border-slate-200/80 shadow-md">
        ...
        <div className="text-center space-y-2 mb-6">
          <div className="w-12 h-12 rounded-xl-none bg-[#ea580c] text-white flex items-center justify-center mx-auto shadow-md">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <div className="flex items-center bg-slate-50 border border-slate-300 rounded-xl-none px-3.5 py-3 focus-within:border-orange-300 focus-within:ring-2 focus-within:ring-orange-100 transition-all">
        ...
        <div className="mt-6 p-3 bg-orange-50 rounded-xl-none border border-orange-200 text-center">
