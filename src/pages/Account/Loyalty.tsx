  ...
  return (
    <AccountLayout>
      <div className="space-y-6">
        ...
        <div className="relative overflow-hidden rounded-xl bg-gradient-to-r from-[#ea580c] via-[#f97316] to-[#c2410c] p-6 sm:p-8 text-white shadow-lg">
          <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-6">
            <div className="space-y-1">
              <span className="text-[10px] font-extrabold uppercase tracking-widest bg-black/30 px-3 py-1 rounded-xl border border-orange-300/40">
                GOLD FAMILY TIER
              </span>
          ...
          <div className="relative z-10 mt-6 pt-4 border-t border-orange-300/60">
            ...
            <div className="w-full h-3 bg-black/40 rounded-xl overflow-hidden p-0.5 border border-orange-300/40">
              <div
                className="h-full bg-gradient-to-r from-amber-300 to-orange-400 rounded-xl transition-all duration-300"
        ...
        <div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
            {rewards.map((r, i) => (
              <div
                key={i}
                className="p-4 rounded-xl bg-white border border-slate-200 flex flex-col justify-between hover:border-[#ea580c] transition-colors shadow-2xs"
              >
                <div>
                  <div className="flex items-center justify-between mb-1">
                    <h4 className="text-xs font-bold text-slate-900">{r.title}</h4>
                    <span className="text-[11px] font-black text-[#ea580c] bg-orange-50 px-2 py-0.5 rounded-xl">
        ...
        <div className="pt-2">
          ...
          <div className="bg-slate-50 rounded-xl p-4 border border-slate-200 divide-y divide-slate-200/70 text-xs">
