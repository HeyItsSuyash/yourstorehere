    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      ...
      <div className="mt-8">
        {matches.length > 0 ? (
          ...
          <div className="bg-white rounded-3xl p-12 text-center border border-slate-200/80 max-w-md mx-auto space-y-4 shadow-xs">
            ...
            <div className="pt-2">
              <Link
                to="/shop"
                className="inline-flex items-center gap-2 bg-emerald-700 hover:bg-emerald-800 text-white font-bold text-xs px-5 py-3 rounded-xl shadow-xs"
              >
