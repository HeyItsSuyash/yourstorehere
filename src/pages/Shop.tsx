  ...
  return (
    <div className="w-full bg-[#f8f9f5] min-h-screen py-6 font-sans">
      <SEO
        ...
        description="Browse our complete supermarket catalog: fresh fruits, vegetables, dairy, staples, snacks, beverages and household cleaners with fast doorstep delivery\."
      />
