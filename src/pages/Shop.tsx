    ...
    <div className="w-full bg-[#f8f9f5] min-h-screen py-6 font-sans">
      <div className="max-w-[1240px] mx-auto px-4">
        ...
        <div className="flex items-center gap-2 text-[11px] text-[#777] mb-4">
          <Link to="/" className="hover:text-[#246b19]">Home</Link>
          <span>/</span>
          ...
          <aside className="hidden lg:block lg:col-span-3 nfb-card p-5 space-y-6 sticky top-28">
            <div className="flex items-center justify-between pb-3 border-b border-[#ecefe6]">
              <div className="flex items-center gap-2">
                <SlidersHorizontal className="w-4 h-4 text-[#246b19]" />
              ...
              <button
                ...
                className="text-xs text-[#246b19] hover:underline font-bold"
              >
                Reset
              </button>
            </div>
            ...
            <div className="pt-2 border-t border-[#ecefe6]">
              <div className="flex items-center justify-between mb-2">
                ...
                <span className="text-xs font-black text-[#246b19]">
                  ₹{maxPrice}
                </span>
              </div>
              <input
                ...
                className="w-full accent-[#246b19] cursor-pointer"
              />
            ...
            <div className="pt-2 border-t border-[#ecefe6]">
              ...
              <div className="space-y-1.5 max-h-40 overflow-y-auto pr-1">
                {brands.map((b) => (
                  <label
                    key={b}
                    className="flex items-center gap-2 text-xs text-[#444] cursor-pointer hover:text-[#246b19] select-none"
                  >
                    <input
                      type="checkbox"
              ...
              <div className="space-y-5">
                ...
                <div>
                  <div className="flex justify-between text-xs mb-1 font-bold">
                    <span>Max Price</span>
                    <span className="text-[#246b19]">₹{maxPrice}</span>
                  </div>
                  <input
                    type="range"
                    min="20"
                    ...
                    onChange={(e) => setMaxPrice(Number(e.target.value))}
                    aria-label="Filter products by maximum price"
                    className="w-full accent-[#246b19]"
                  />
                  <div className="flex justify-between text-[10px] text-[#888] mt-1">
                    <span>₹20</span>
                    <span>₹600+</span>
