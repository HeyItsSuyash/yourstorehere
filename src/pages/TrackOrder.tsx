  ...
  return (
    <div className="max-w-4xl mx-auto px-4 py-8">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <span className="bg-orange-100 text-[#c2410c] text-xs font-black px-3 py-1.5 rounded-xl-none uppercase tracking-wider">
          {currentOrder.status}
        </span>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-7 space-y-6">
          ...
          <div className="bg-slate-950 rounded-xl-none p-6 text-white relative overflow-hidden shadow-lg border border-slate-800">
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-6">
                ...
                <div className="w-12 h-12 rounded-xl-none bg-orange-500/20 text-orange-400 flex items-center justify-center border border-orange-500/30">
                  <Navigation className="w-6 h-6 animate-pulse" />
                </div>
              </div>

              {/* Graphic delivery path */}
              <div className="bg-slate-900/80 rounded-xl-none p-4 border border-slate-800 mb-4">
                ...
                {/* Progress track */}
                <div className="w-full h-2.5 bg-slate-950 rounded-xl-none overflow-hidden p-0.5 border border-[#ea580c]">
                  <div className="h-full bg-gradient-to-r from-[#ea580c] to-amber-400 rounded-xl-none w-3/4 animate-pulse" />
                </div>
              </div>
              ...
              <div className="flex items-center justify-between bg-white/10 backdrop-blur-xs rounded-xl-none p-3.5 border border-white/10">
                <div className="flex items-center gap-3">
                  <div className="w-10 h-10 rounded-xl-none bg-[#ea580c] text-white flex items-center justify-center font-black text-sm">
                ...
                <a
                  ...
                  className="flex items-center gap-1 bg-[#ea580c] hover:bg-[#c2410c] text-white text-xs font-black px-3.5 py-2 rounded-xl-none transition-colors shadow-xs"
                >
