...
export const About: React.FC = () => {
  return (
    <div className="max-w-5xl mx-auto px-4 py-10 space-y-12">
      <SEO
        title="About Us - Your Trusted Supermarket"
        description="Learn more about Your Store Here, our mission to deliver farm-fresh groceries and authentic household products at honest everyday prices in Metro City."
      />
      {/* Hero */}
      <div className="text-center space-y-4 max-w-2xl mx-auto">
        <div className="inline-flex items-center gap-1.5 bg-emerald-100 text-[#9a3412] text-xs font-bold px-3 py-1 rounded-xl">
        ...
        <p className="text-sm text-slate-600 leading-relaxed">
          At Your Store Here, we believe grocery shopping should be simple, affordable, and full of fresh choices that bring Indian families together around the dinner table.
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        <div className="p-6 bg-white rounded-xl border border-slate-200/80 shadow-xs space-y-3">
          <div className="w-12 h-12 rounded-xl bg-emerald-50 text-[#c2410c] flex items-center justify-center font-bold">
      ...
      {/* Our Promise Banner */}
      <div className="bg-gradient-to-r from-[#c2410c] to-[#9a3412] rounded-xl p-8 sm:p-10 text-white text-center space-y-4">
        ...
        <div className="pt-2">
          <Link
            to="/shop"
            className="inline-flex items-center gap-2 bg-white text-[#7c2d12] font-bold text-xs px-6 py-3 rounded-xl shadow-md hover:bg-emerald-50"
          >
