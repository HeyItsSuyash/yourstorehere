...
export const About: React.FC = () => {
  return (
    <div className="max-w-5xl mx-auto px-4 py-10 space-y-12">
      <SEO
        title="About Us - Gomti Nagar's Trusted Supermarket"
        description="Learn more about Express daily Mart, our mission to deliver farm-fresh groceries and authentic household products at honest everyday prices in Gomti Nagar, Lucknow."
      />
      {/* Hero */}
      <div className="text-center space-y-4 max-w-2xl mx-auto">
        <div className="inline-flex items-center gap-1.5 bg-emerald-100 text-[#166534] text-xs font-bold px-3 py-1 rounded-xl">
        ...
        <p className="text-sm text-slate-600 leading-relaxed">
          At Express daily Mart, we believe grocery shopping should be simple, affordable, and full of fresh choices that bring Indian families together around the dinner table.
        </p>
      </div>
      ...
      {/* Our Promise Banner */}
      <div className="bg-gradient-to-r from-[#15803d] to-[#166534] rounded-xl p-8 sm:p-10 text-white text-center space-y-4">
        ...
        <div className="pt-2">
          <Link
            to="/shop"
            className="inline-flex items-center gap-2 bg-white text-[#14532d] font-bold text-xs px-6 py-3 rounded-xl shadow-md hover:bg-emerald-50"
          >
